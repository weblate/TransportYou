...
object TransportNetworks {
    val networks = arrayOf(
        ...
        TransportNetwork(
            ...
            continent = Continent.Europe,
            factory = {
                VbbProvider("{\"type\":\"AID\",\"aid\":\"hafas-vbb-apps\"}", "RCTJM2fFxFfxxQfI")
            }
        ),
        TransportNetwork(
            id = NetworkId.BAYERN,
        ...
        TransportNetwork(
            ...
            continent = Continent.Europe,
            factory = {
                InvgProvider("{\"type\":\"AID\",\"aid\":\"GITvwi3BGOmTQ2a5\"}", "ERxotxpwFT7uYRsI")
            }
        ),
        TransportNetwork(
            id = NetworkId.VBN,
            ...
            continent = Continent.Europe,
            factory = {
                VbnProvider("{\"type\":\"AID\",\"aid\":\"rnOHBWhesvc7gFkd\"}", "SP31mBufSyCLmNxp")
            }
        ),
        TransportNetwork(
            id = NetworkId.SH,
        ...
        TransportNetwork(
            ...
            continent = Continent.Europe,
            factory = {
                VmobilProvider("{\"aid\":\"hf7mcf9bv3nv8g5f\",\"pw\":\"87a6f8ZbnBih32\",\"type\":\"USER\",\"user\":\"mobile\"}")
            },
        ),
        TransportNetwork(
            id = NetworkId.VBL,
